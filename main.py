...
date_picker_from = DatePicker(title = "Start Date", value = "2020-01-01", min_date = "2000-01-02",
                                max_date =dt.datetime.now().strftime("%Y-%m-%d"))   

date_picker_to = DatePicker(title = "End Date", value = "2021-02-01", min_date = "2000-02-02",
                                max_date =dt.datetime.now().strftime("%Y-%m-%d"))       
